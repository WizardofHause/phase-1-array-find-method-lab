...
//USES ARRAY.RECORD AND SEARCHES THROUGH EACH ELEMENT. RETURNS THE VALUE 'TRUE'
// IF THE ELEMENT HAS ANY PARTICULAR VALUES THAT === 'W', AND RETURNS THOSE ELEMENTS
//IN THIS CASE '{YEAR: 2015, RESULT: 'W'}'

//THE !! OPERATOR TURNS THE STATEMENT '{YEAR: 2015, RESULT: 'W'}' INTO THE VALUE 'TRUE',
//WHICH THEN DETERMINES THE RETURN VALUE FROM OUR FINAL TERNARY STATEMENT